...
export default function Footer() {
  return (
    <footer className="border-t bg-gray-50">
      <div className="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 py-8 md:flex-row md:items-start md:justify-between md:px-6 md:py-10">
        {/* Marca */}
        ...
        <div className="grid grid-cols-3 gap-4 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link href="/kits" className="hover:text-gray-900">
                  Kits
                </Link>
              </li>
            </ul>
