...
import { fetchCustomers, fetchProducts, fetchCategories, fetchSales } from '@/app/lib/data';
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {cards.map((card) => {
          ...
          return (
            ...
            >
              <div className={`flex h-14 w-14 items-center justify-center rounded-full ${card.color}`}>
